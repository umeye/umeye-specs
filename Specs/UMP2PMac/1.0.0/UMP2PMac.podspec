...
TODO: Add long description of the pod here.
  ...
  s.source           = { :http => 'http://docs.kdzn.top/pod/p2p-sdk-mac/1.0.0/p2p-sdk-mac.zip' }
  ...
  s.dependency 'UMBasisMac', '2.0.6'

  s.libraries   = 'bz2', 'iconv', 'c++'
  s.frameworks  = 'AppKit', 'CFNetwork'
end
